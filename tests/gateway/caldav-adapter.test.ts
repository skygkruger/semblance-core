// CalDAV Adapter Tests — Validates the CalDAVAdapter against connection and error handling.
...
import { CalDAVAdapter } from '@semblance/gateway/services/calendar/caldav-adapter.js';
