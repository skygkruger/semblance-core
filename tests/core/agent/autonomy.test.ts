...
describe('AutonomyManager', () => {
  ...
  describe('Guardian mode', () => {
    it('requires approval for all actions', () => {
      const manager = new AutonomyManager(db, { defaultTier: 'guardian', domainOverrides: {} });
  ...
  describe('Partner mode', () => {
    it('auto-approves read actions', () => {
      const manager = new AutonomyManager(db, { defaultTier: 'partner', domainOverrides: {} });
  ...
  describe('Alter Ego mode', () => {
    it('auto-approves most actions', () => {
      const manager = new AutonomyManager(db, { defaultTier: 'alter_ego', domainOverrides: {} });
