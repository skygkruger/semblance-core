// LlamaCpp Bridge — JS adapter wrapping the Android native module (SemblanceLlama)
// into the MobileInferenceBridge interface.
//
// On non-Android platforms, this module is never imported. The InferenceRouter
...
interface SemblanceLlamaNativeModule {
  loadModel(
    modelPath: string,
...
export class LlamaCppBridgeAdapter implements MobileInferenceBridge {
  ...
  constructor(nativeModule: SemblanceLlamaNativeModule) {
