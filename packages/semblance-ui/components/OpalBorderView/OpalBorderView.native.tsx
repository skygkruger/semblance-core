...
export const OPAL_BORDER_COLORS = [
  ...
  'rgba(165,170,255,0.55)',
  'rgba(180,185,255,0.6)',
  'rgba(165,170,255,0.55)',
  'rgba(129,140,248,0.45)',
  'rgba(99,102,241,0.35)',
];
...
export const USER_BORDER_COLORS = [
  ...
  'rgba(165,170,255,0.30)',
  'rgba(180,185,255,0.34)',
  'rgba(165,170,255,0.30)',
  'rgba(129,140,248,0.24)',
  'rgba(99,102,241,0.18)',
];
...
const SHIMMER_OVERLAY_COLORS = [
  ...
  'rgba(165,170,255,0.08)',
  'rgba(180,185,255,0.11)',
  'rgba(180,185,255,0.08)',
  'rgba(165,170,255,0.06)',
