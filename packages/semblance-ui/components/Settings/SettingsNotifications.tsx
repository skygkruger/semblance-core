...
const snoozeLabels: Record<string, string> = { '5m': '5 min', '15m': '15 min', '1h': '1 hour', '1d': '1 day' };
const digestLabels: Record<string, string> = { immediate: 'Immediate', hourly: 'Hourly', daily: 'Daily summary' };
