...
interface SettingsAutonomyProps {
  currentTier: 'guardian' | 'partner' | 'alter-ego';
...
type Tier = 'guardian' | 'partner' | 'alter-ego';
...
const tiers: Array<{ id: Tier; name: string; desc: string }> = [
...
const domains = ['Email', 'Calendar', 'Files', 'Finance', 'Health', 'Services'];

const reviewLabels: Record<string, string> = { '30s': '30 seconds', '1m': '1 minute', '5m': '5 minutes' };
