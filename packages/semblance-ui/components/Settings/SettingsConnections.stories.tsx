...
const allConnections = [
  ...
  { id: 'calendar', name: 'Calendar (CalDAV)', category: 'scheduling', categoryColor: '#EDDD52', isConnected: true, lastSync: '5m ago', entityCount: 342 },
  ...
  { id: 'health', name: 'Apple Health', category: 'health', categoryColor: '#E8657A', isConnected: false, lastSync: null, entityCount: 0 },
];
