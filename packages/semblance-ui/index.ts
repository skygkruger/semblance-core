...
export type { DocumentPanelProps, DocumentPanelFile } from './components/DocumentPanel/index.js';
...
export type { PremiumFeature, FeatureGateProps } from './components/FeatureGate/index.js';
